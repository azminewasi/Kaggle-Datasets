...
f = open("attacking.txt", "r", encoding='utf-8')
data=f.readlines()
...
df_dict={"serial":serial,"player_name":player,"club":club,"position":position,"assists":total_attempts,"corner_taken":on_target,"offsides":off_target,"dribbles":blocked,"match_played":match_played}

df=pd.DataFrame.from_dict(df_dict)
print(df.head())

df.to_csv("attacking.csv",index=False)