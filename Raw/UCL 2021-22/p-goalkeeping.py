...
f = open("goalkeeping.txt", "r", encoding='utf-8')
data=f.readlines()
...
df_dict={"serial":serial,"player_name":player,"club":club,"position":position,"saved":total_attempts,"conceded":on_target,"saved_penalties":off_target,"cleansheets":blocked,"punches made":match_played,"match_played":c11}

df=pd.DataFrame.from_dict(df_dict)
print(df.head())

df.to_csv("goalkeeping.csv",index=False)