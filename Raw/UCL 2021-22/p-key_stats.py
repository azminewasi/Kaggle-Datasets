...
f = open("key_stats - new.txt", "r", encoding='utf-8')
data=f.readlines()
...
df_dict={"serial":serial,"player_name":player,"club":club,"position":position,"minutes_played":total_attempts,"match_played":on_target,"goals":off_target,"assists":blocked,"distance_covered":match_played}

df=pd.DataFrame.from_dict(df_dict)
print(df.head())

df.to_csv("key_stats - new.csv",index=False)