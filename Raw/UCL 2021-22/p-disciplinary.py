...
f = open("distributon.txt", "r", encoding='utf-8')
data=f.readlines()
...
df_dict={"serial":serial,"player_name":player,"club":club,"position":position,"pass_accuracy":total_attempts,"pass_attempted":on_target,"pass_completed":off_target,"cross_accuracy":blocked,"cross_attempted":match_played,"cross_complted":c11,"freekicks_taken":c12,"match_played":c13}

df=pd.DataFrame.from_dict(df_dict)
print(df.head())

df.to_csv("distributon.csv",index=False)